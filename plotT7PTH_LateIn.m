...
plot(Tm(2:end-1), INRESP.CSplus.preMB.MeanPTHz(1:end-1), 'color',[0.45, 0.85, 0.95] , 'Linewidth', 3);

hold on
plot(Tm(2:end-1), preMBSEMabove(1:end-1),'color', [0.45, 0.85, 0.95], 'Linewidth', 0.25);
hold on
plot(Tm(2:end-1), preMBSEMbelow(1:end-1),'color', [0.45, 0.85, 0.95], 'Linewidth', 0.25);
...
plot(Tm(2:end-1), INRESP.CSplus.postMB.MeanPTHz(1:end-1), 'color',[0.45, 0.85, 0.95] , 'Linewidth', 3);

hold on
plot(Tm(2:end-1), postMBSEMabove(1:end-1),'color', [0.45, 0.85, 0.95], 'Linewidth', 0.25);
hold on
plot(Tm(2:end-1), postMBSEMbelow(1:end-1),'color', [0.45, 0.85, 0.95], 'Linewidth', 0.25);
