            ...
            for enum=1:length(NDATA{anum}{daynum}{sessionnum}) %electrodes
                for neurnum=1:length(NDATA{anum}{daynum}{sessionnum}{enum})%neurons
                    ...
                    [RESP.CSplus.PSR{anum}{daynum}{sessionnum}{enum}{neurnum},~]=...
                        MakePSR04(NDATA{anum}{daynum}{sessionnum}{enum}{neurnum}.spiketimes,BDATA{anum}{daynum}{sessionnum}.csplustimes,Dura,{2});
                    ...
                    [RESP.CSplus.PTH{anum}{daynum}{sessionnum}{enum}{neurnum},~,~]=...
                        MakePTH08(RESP.CSplus.PSR{anum}{daynum}{sessionnum}{enum}{neurnum},size(RESP.CSplus.PSR{anum}{daynum}{sessionnum}{enum}{neurnum},2),{2,0,BSIZE});
