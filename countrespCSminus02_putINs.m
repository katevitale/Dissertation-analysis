...
LongInpropminus(1)=((LongIn_s1 + IoI_s1 + LateInoII_s1 + ...
            LateInooI_s1)/total_s1)*100;
LongInpropminus(2)=((LongIn_s2 + IoI_s2 + LateInoII_s2 + ...
            LateInooI_s2)/total_s2)*100;
LongInpropminus(3)=((LongIn_s3 + IoI_s3 + LateInoII_s3 + ...
            LateInooI_s3)/total_s3)*100;
LongInpropminus(4)=((LongIn_s4 + IoI_s4 + LateInoII_s4 + ...
            LateInooI_s4)/total_s4)*100;
LongInpropminus(5)=((LongIn_s5 + IoI_s5 + LateInoII_s5 + ...
            LateInooI_s5)/total_s5)*100;        
LongInpropminus(6)=((LongIn_s6 + IoI_s6 + LateInoII_s6 + ...
            LateInooI_s6)/total_s6)*100;
LongInpropminus(7)=((LongIn_s7 + IoI_s7 + LateInoII_s7 + ...
            LateInooI_s7)/total_s7)*100;
LongInpropminus(8)= NaN;        
LongInpropminus(9)=((LongIn_EXT + IoI_EXT + LateInoII_EXT + ...
            LateInooI_EXT)/total_EXT)*100;        
LongInpropminus(10)=((LongIn_EREC + IoI_EREC + LateInoII_EREC + ...
            LateInooI_EREC)/total_EREC)*100;
LongInpropminus(11)= NaN; 
LongInpropminus(12)=((LongIn_preMB + IoI_preMB + LateInoII_preMB + ...
            LateInooI_preMB)/total_preMB)*100;
LongInpropminus(13)=((LongIn_postMB + IoI_postMB + LateInoII_postMB + ...
            LateInooI_postMB)/total_postMB)*100;
LongInpropminus(14)=((LongIn_preSAL + IoI_preSAL + LateInoII_preSAL + ...
            LateInooI_preSAL)/total_preSAL)*100;
LongInpropminus(15)=((LongIn_postSAL + IoI_postSAL + LateInoII_postSAL + ...
            LateInooI_postSAL)/total_postSAL)*100;
        
        
LateInpropminus(1)=((LongIn_s1 + IoI_s1 + MultIEI_s1 + LateInoII_s1 + ...
            LateInooI_s1 + MultoEI_s1 + MultEII_s1 + MultEoI_s1 +...
             MultEEI_s1)/total_s1)*100;
LateInpropminus(2)=((LongIn_s2 + IoI_s2 + MultIEI_s2 + LateInoII_s2 + ...
            LateInooI_s2 + MultoEI_s2 + MultEII_s2 + MultEoI_s2 +...
             MultEEI_s2)/total_s2)*100;
LateInpropminus(3)=((LongIn_s3 + IoI_s3 + MultIEI_s3 + LateInoII_s3 + ...
            LateInooI_s3 + MultoEI_s3 + MultEII_s3 + MultEoI_s3 +...
             MultEEI_s3)/total_s3)*100; 
LateInpropminus(4)=((LongIn_s4 + IoI_s4 + MultIEI_s4 + LateInoII_s4 + ...
            LateInooI_s4 + MultoEI_s4 + MultEII_s4 + MultEoI_s4 +...
             MultEEI_s4)/total_s4)*100; 
LateInpropminus(5)=((LongIn_s5 + IoI_s5 + MultIEI_s5 + LateInoII_s5 + ...
            LateInooI_s5 + MultoEI_s5 + MultEII_s5 + MultEoI_s5 +...
             MultEEI_s5)/total_s5)*100;
LateInpropminus(6)=((LongIn_s6 + IoI_s6 + MultIEI_s6 + LateInoII_s6 + ...
            LateInooI_s6 + MultoEI_s6 + MultEII_s6 + MultEoI_s6 +...
             MultEEI_s6)/total_s6)*100;
LateInpropminus(7)=((LongIn_s7 + IoI_s7 + MultIEI_s7 + LateInoII_s7 + ...
            LateInooI_s7 + MultoEI_s7 + MultEII_s7 + MultEoI_s7 +...
             MultEEI_s7)/total_s7)*100;                                            
LateInpropminus(8)= NaN;
LateInpropminus(9)=((LongIn_EXT + IoI_EXT + MultIEI_EXT + LateInoII_EXT + ...
            LateInooI_EXT + MultoEI_EXT + MultEII_EXT + MultEoI_EXT +...
             MultEEI_EXT)/total_EXT)*100;
LateInpropminus(10)=((LongIn_EREC + IoI_EREC + MultIEI_EREC + LateInoII_EREC + ...
            LateInooI_EREC + MultoEI_EREC + MultEII_EREC + MultEoI_EREC +...
             MultEEI_EREC)/total_EREC)*100;
LateInpropminus(11)= NaN;
LateInpropminus(12)=((LongIn_preMB + IoI_preMB + MultIEI_preMB + LateInoII_preMB + ...
            LateInooI_preMB + MultoEI_preMB + MultEII_preMB + MultEoI_preMB +...
             MultEEI_preMB)/total_preMB)*100;
LateInpropminus(13)=((LongIn_postMB + IoI_postMB + MultIEI_postMB + LateInoII_postMB + ...
            LateInooI_postMB + MultoEI_postMB + MultEII_postMB + MultEoI_postMB +...
             MultEEI_postMB)/total_postMB)*100;
LateInpropminus(14)=((LongIn_preSAL + IoI_preSAL + MultIEI_preSAL + LateInoII_preSAL + ...
            LateInooI_preSAL + MultoEI_preSAL + MultEII_preSAL + MultEoI_preSAL +...
             MultEEI_preSAL)/total_preSAL)*100;
LateInpropminus(15)=((LongIn_postSAL + IoI_postSAL + MultIEI_postSAL + LateInoII_postSAL + ...
            LateInooI_postSAL + MultoEI_postSAL + MultEII_postSAL + MultEoI_postSAL +...
             MultEEI_postSAL)/total_postSAL)*100;

LongExpropminus(1)=((LongEx_s1 + EoE_s1 + LateExoEE_s1 + ...
            LateExooE_s1)/total_s1)*100;
LongExpropminus(2)=((LongEx_s2 + EoE_s2 + LateExoEE_s2 + ...
            LateExooE_s2)/total_s2)*100;
LongExpropminus(3)=((LongEx_s3 + EoE_s3 + LateExoEE_s3 + ...
            LateExooE_s3)/total_s3)*100;
LongExpropminus(4)=((LongEx_s4 + EoE_s4 + LateExoEE_s4 + ...
            LateExooE_s4)/total_s4)*100;
LongExpropminus(5)=((LongEx_s5 + EoE_s5 + LateExoEE_s5 + ...
            LateExooE_s5)/total_s5)*100;        
LongExpropminus(6)=((LongEx_s6 + EoE_s6 + LateExoEE_s6 + ...
            LateExooE_s6)/total_s6)*100;
LongExpropminus(7)=((LongEx_s7 + EoE_s7 + LateExoEE_s7 + ...
            LateExooE_s7)/total_s7)*100;
LongExpropminus(8)= NaN;        
LongExpropminus(9)=((LongEx_EXT + EoE_EXT + LateExoEE_EXT + ...
            LateExooE_EXT)/total_EXT)*100;        
LongExpropminus(10)=((LongEx_EREC + EoE_EREC + LateExoEE_EREC + ...
            LateExooE_EREC)/total_EREC)*100;
LongExpropminus(11)= NaN; 
LongExpropminus(12)=((LongEx_preMB + EoE_preMB + LateExoEE_preMB + ...
            LateExooE_preMB)/total_preMB)*100;
LongExpropminus(13)=((LongEx_postMB + EoE_postMB + LateExoEE_postMB + ...
            LateExooE_postMB)/total_postMB)*100;
LongExpropminus(14)=((LongEx_preSAL + EoE_preSAL + LateExoEE_preSAL + ...
            LateExooE_preSAL)/total_preSAL)*100;
LongExpropminus(15)=((LongEx_postSAL + EoE_postSAL + LateExoEE_postSAL + ...
            LateExooE_postSAL)/total_postSAL)*100;         
         
LateExpropminus(1)=((MultIIE_s1 + MultIoE_s1 + MultIEE_s1 + MultoIE_s1 + ...
            LateExooE_s1 + LateExoEE_s1 + MultEIE_s1 + EoE_s1 +...
             LongEx_s1)/total_s1)*100;
LateExpropminus(2)=((MultIIE_s2 + MultIoE_s2 + MultIEE_s2 + MultoIE_s2 + ...
            LateExooE_s2 + LateExoEE_s2 + MultEIE_s2 + EoE_s2 +...
             LongEx_s2)/total_s2)*100;
LateExpropminus(3)=((MultIIE_s3 + MultIoE_s3 + MultIEE_s3 + MultoIE_s3 + ...
            LateExooE_s3 + LateExoEE_s3 + MultEIE_s3 + EoE_s3 +...
             LongEx_s3)/total_s3)*100; 
LateExpropminus(4)=((MultIIE_s4 + MultIoE_s4 + MultIEE_s4 + MultoIE_s4 + ...
            LateExooE_s4 + LateExoEE_s4 + MultEIE_s4 + EoE_s4 +...
             LongEx_s4)/total_s4)*100;
LateExpropminus(5)=((MultIIE_s5 + MultIoE_s5 + MultIEE_s5 + MultoIE_s5 + ...
            LateExooE_s5 + LateExoEE_s5 + MultEIE_s5 + EoE_s5 +...
             LongEx_s5)/total_s5)*100;
LateExpropminus(6)=((MultIIE_s6 + MultIoE_s6 + MultIEE_s6 + MultoIE_s6 + ...
            LateExooE_s6 + LateExoEE_s6 + MultEIE_s6 + EoE_s6 +...
             LongEx_s6)/total_s6)*100;
LateExpropminus(7)=((MultIIE_s7 + MultIoE_s7 + MultIEE_s7 + MultoIE_s7 + ...
            LateExooE_s7 + LateExoEE_s7 + MultEIE_s7 + EoE_s7 +...
             LongEx_s7)/total_s7)*100;
LateExpropminus(8)=NaN;
LateExpropminus(9)=((MultIIE_EXT + MultIoE_EXT + MultIEE_EXT + MultoIE_EXT + ...
            LateExooE_EXT + LateExoEE_EXT + MultEIE_EXT + EoE_EXT +...
             LongEx_EXT)/total_EXT)*100;
LateExpropminus(10)=((MultIIE_EREC + MultIoE_EREC + MultIEE_EREC + MultoIE_EREC + ...
            LateExooE_EREC + LateExoEE_EREC + MultEIE_EREC + EoE_EREC +...
             LongEx_EREC)/total_EREC)*100;                                      
LateExpropminus(11)=NaN;
LateExpropminus(12)=((MultIIE_preMB + MultIoE_preMB + MultIEE_preMB + MultoIE_preMB + ...
            LateExooE_preMB + LateExoEE_preMB + MultEIE_preMB + EoE_preMB +...
             LongEx_preMB)/total_preMB)*100;                                            
LateExpropminus(13)=((MultIIE_postMB + MultIoE_postMB + MultIEE_postMB + MultoIE_postMB + ...
            LateExooE_postMB + LateExoEE_postMB + MultEIE_postMB + EoE_postMB +...
             LongEx_postMB)/total_postMB)*100;
LateExpropminus(14)=((MultIIE_preSAL + MultIoE_preSAL + MultIEE_preSAL + MultoIE_preSAL + ...
            LateExooE_preSAL + LateExoEE_preSAL + MultEIE_preSAL + EoE_preSAL +...
             LongEx_preSAL)/total_preSAL)*100;                                            
LateExpropminus(15)=((MultIIE_postSAL + MultIoE_postSAL + MultIEE_postSAL + MultoIE_postSAL + ...
...
total(8)=total_EXT;
total(9)=total_EREC;
total(10)=total_preMB;
total(11)=total_postMB;
total(12)=total_preSAL;
total(13)=total_postSAL;
